...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Threads Die , Pls Check");
    }
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Twitter: @Anonymouts_VNPC");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("[+] in progress sending data to the server: " + responseCode + " number send: " + this.seq);
    }
